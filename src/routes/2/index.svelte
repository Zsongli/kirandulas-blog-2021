...
<div style="max-width: 2560px;" class="flex items-center justify-evenly flex-wrap mt-20 m-auto">
	...
	<Card title="Nyomda" bottomText="Vizsoly">
		<div
	...
	<Card title="Boldogkő vára" bottomText="Boldogkőváralja">
		<div
	...
	<Card title="Kollégium könyvtár" bottomText="Sárospatak">
        <div
	...
	<Card title="A Magyar Nyelv Múzeuma" bottomText="Széphalom">
        <div
